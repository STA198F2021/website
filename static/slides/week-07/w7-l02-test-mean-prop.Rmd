...
The researcher enrolled 239 subjects and obtained complete data on 205, with 85 males and 120 females in the complete data sample.  Analyzing the data, we obtain $\bar{x}_{MALE}=13.33$, $\bar{x}_{FEMALE}=10.73$, $s_{MALE}=4.02$, $s_{FEMALE}=4.25$.
