...
```{r load-data}
unvotes <- read_rds("/Users/amyherring/Documents/GitHub/application-exercises/ae-01a-un-votes/data/unvotes.rds")
```
...
unvotes %>%
  filter(country %in% c("Israel", "US", "Iran (Islamic Republic of)","China")) %>%
