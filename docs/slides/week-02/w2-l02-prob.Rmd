...
- $P(A mid B)$, the probability a woman in Washington state is American Indian or Alaska Native given that she is missing
...
Consider a missing woman in Alaska. Use Bayes's Theorem to derive the probability that she is Alaska Native or American Indian, given that she is missing. How does this probability compare to the probability you calculated for Washington?
