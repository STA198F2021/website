...
**Relative risk** and **relative odds** are two measures used to compare the likelihood of an outcome across groups.  
AMY FILL IN FROM P and G. Also decide whether to handle ROC/AUC here or in binary classification (I tend to think we should put it there).
